...
@section('title', 'Add Domestic Package')
@section('header-title', 'Add Domestic Package')
@section('content')
    <div class="content-page">
        <div class="content">
            <div class="container">
                <div class="py-3">
                    <h4 class="fs-18 fw-semibold m-0">Add Domestic Package</h4>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('domestic-package.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="destination_city" class="form-control"
                                                placeholder="e.g. Murree" value="{{ old('destination_city') }}" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="hotel_rating" class="form-select">
                                                ...
                                                @foreach (['3 Star', '4 Star', '5 Star'] as $rating)
                                                    <option value="{{ $rating }}"
                                                        {{ old('hotel_rating') == $rating ? 'selected' : '' }}>
                                                        {{ $rating }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" name="duration_days" class="form-control"
                                                placeholder="e.g. 3" value="{{ old('duration_days') }}">
                                        </div>
