...
@section('header-title', 'Edit Hajj Package')
@section('content')
    <div class="content-page">
        <div class="content">
            <div class="container">
                <div class="py-3">
                    <h4 class="fs-18 fw-semibold m-0">Edit Hajj Package</h4>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="maktab_category" class="form-control"
                                                placeholder="e.g. Category A, Maktab 3" value="{{ old('maktab_category', $package->maktab_category) }}">
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Zone</label>
                                            <input type="text" name="zone" class="form-control"
                                                placeholder="e.g. Zone A" value="{{ old('zone', $package->zone) }}">
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">No of Days</label>
                                            <input type="text" name="no_of_days" class="form-control"
                                                placeholder="e.g. 40 Days" value="{{ old('no_of_days', $package->no_of_days) }}">
                                        </div>
                                            ...
                                            <select name="makkah_hotel_name" class="form-select makkah-hotel-select">
                                                ...
                                                @foreach ($makkahHotels as $hotel)
                                                    <option value="{{ $hotel->name }}"
                                                        ...
                                                        {{ old('makkah_hotel_name', $package->makkah_hotel_name) == $hotel->name ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="makkah_hotel_distance" id="makkah_hotel_distance"
                                                ...
                                                value="{{ old('makkah_hotel_distance', $package->makkah_hotel_distance) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="makkah_hotel_period" class="form-control"
                                                ...
                                                value="{{ old('makkah_hotel_period', $package->makkah_hotel_period) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="makkah_hotel_meal_plan" class="form-select">
                                                ...
                                                @foreach($mealTypes as $meal)
                                                    <option value="{{ $meal->name }}" {{ old('makkah_hotel_meal_plan', $package->makkah_hotel_meal_plan) == $meal->name ? 'selected' : '' }}>
                                                        {{ $meal->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="makkah_hotel_category" class="form-control"
                                                placeholder="e.g. 5 Star" value="{{ old('makkah_hotel_category', $package->makkah_hotel_category) }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="madinah_hotel_name" class="form-select madinah-hotel-select">
                                                ...
                                                @foreach ($madinahHotels as $hotel)
                                                    <option value="{{ $hotel->name }}"
                                                        data-distance="{{ $hotel->distance }}"
                                                        {{ old('madinah_hotel_name', $package->madinah_hotel_name) == $hotel->name ? 'selected' : '' }}>
                                                        {{ $hotel->name }} ({{ $hotel->star_rating }}★)
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="madinah_hotel_distance" id="madinah_hotel_distance"
                                                ...
                                                value="{{ old('madinah_hotel_distance', $package->madinah_hotel_distance) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="madinah_hotel_period" class="form-control"
                                                ...
                                                value="{{ old('madinah_hotel_period', $package->madinah_hotel_period) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="madinah_hotel_meal_plan" class="form-select">
                                                <option value="">Select Meal Plan</option>
                                                @foreach($mealTypes as $meal)
                                                    <option value="{{ $meal->name }}" {{ old('madinah_hotel_meal_plan', $package->madinah_hotel_meal_plan) == $meal->name ? 'selected' : '' }}>
                                                        {{ $meal->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="madinah_hotel_category" class="form-control"
                                                placeholder="e.g. 5 Star" value="{{ old('madinah_hotel_category', $package->madinah_hotel_category) }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="azizia_hotel_name" class="form-select azizia-hotel-select">
                                                ...
                                                @foreach ($aziziaHotels as $hotel)
                                                    <option value="{{ $hotel->name }}"
                                                        data-distance="{{ $hotel->distance }}"
                                                        {{ old('azizia_hotel_name', $package->azizia_hotel_name) == $hotel->name ? 'selected' : '' }}>
                                                        {{ $hotel->name }} ({{ $hotel->star_rating }}★)
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="azizia_hotel_distance" id="azizia_hotel_distance"
                                                ...
                                                value="{{ old('azizia_hotel_distance', $package->azizia_hotel_distance) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="azizia_hotel_period" class="form-control"
                                                ...
                                                value="{{ old('azizia_hotel_period', $package->azizia_hotel_period) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="azizia_hotel_meal_plan" class="form-select">
                                                <option value="">Select Meal Plan</option>
                                                @foreach($mealTypes as $meal)
                                                    <option value="{{ $meal->name }}" {{ old('azizia_hotel_meal_plan', $package->azizia_hotel_meal_plan) == $meal->name ? 'selected' : '' }}>
                                                        {{ $meal->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="azizia_hotel_category" class="form-control"
                                                placeholder="e.g. Building" value="{{ old('azizia_hotel_category', $package->azizia_hotel_category) }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="qurbani" class="form-select">
                                                <option value="Included" {{ old('qurbani', $package->qurbani) == 'Included' ? 'selected' : '' }}>Included</option>
                                                <option value="Not Included" {{ old('qurbani', $package->qurbani) == 'Not Included' ? 'selected' : '' }}>Not Included</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="airline_ticket" class="form-select">
                                                <option value="Not Included" {{ old('airline_ticket', $package->airline_ticket) == 'Not Included' ? 'selected' : '' }}>Not Included</option>
                                                <option value="Direct Airline" {{ old('airline_ticket', $package->airline_ticket) == 'Direct Airline' ? 'selected' : '' }}>Direct Airline</option>
                                                <option value="Indirect Airline" {{ old('airline_ticket', $package->airline_ticket) == 'Indirect Airline' ? 'selected' : '' }}>Indirect Airline</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="ziarat" class="form-select">
                                                <option value="Included" {{ old('ziarat', $package->ziarat) == 'Included' ? 'selected' : '' }}>Included</option>
                                                <option value="Not Included" {{ old('ziarat', $package->ziarat) == 'Not Included' ? 'selected' : '' }}>Not Included</option>
                                            </select>
                                        </div>
                                        ...
                                        <div id="transportation_segments_container" class="row g-3" style="display: none;">
                                            <div class="col-md-6 mb-2 trans-segment" data-segment="jeddah_makk">
                                                ...
                                                <select name="trans_jeddah_makkah" class="form-select">
                                                    ...
                                                    <option value="Bus" {{ old('trans_jeddah_makkah', $package->trans_jeddah_makkah) == 'Bus' ? 'selected' : '' }}>Bus</option>
                                                    <option value="Private Car" {{ old('trans_jeddah_makkah', $package->trans_jeddah_makkah) == 'Private Car' ? 'selected' : '' }}>Private Car</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2 trans-segment" data-segment="makkah_madinah">
                                                ...
                                                <select name="trans_makkah_madinah" class="form-select">
                                                    <option value="">Select Option</option>
                                                    <option value="Bus" {{ old('trans_makkah_madinah', $package->trans_makkah_madinah) == 'Bus' ? 'selected' : '' }}>Bus</option>
                                                    <option value="Train" {{ old('trans_makkah_madinah', $package->trans_makkah_madinah) == 'Train' ? 'selected' : '' }}>Train</option>
                                                    <option value="Private Car" {{ old('trans_makkah_madinah', $package->trans_makkah_madinah) == 'Private Car' ? 'selected' : '' }}>Private Car</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2 trans-segment" data-segment="madinah_makkah">
                                                ...
                                                <select name="trans_madinah_makkah" class="form-select">
                                                    <option value="">Select Option</option>
                                                    <option value="Bus" {{ old('trans_madinah_makkah', $package->trans_madinah_makkah) == 'Bus' ? 'selected' : '' }}>Bus</option>
                                                    <option value="Train" {{ old('trans_madinah_makkah', $package->trans_madinah_makkah) == 'Train' ? 'selected' : '' }}>Train</option>
                                                    <option value="Private Car" {{ old('trans_madinah_makkah', $package->trans_madinah_makkah) == 'Private Car' ? 'selected' : '' }}>Private Car</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2 trans-segment" data-segment="makkah_jeddah">
                                                ...
                                                <select name="trans_makkah_jeddah" class="form-select">
                                                    <option value="">Select Option</option>
                                                    <option value="Bus" {{ old('trans_makkah_jeddah', $package->trans_makkah_jeddah) == 'Bus' ? 'selected' : '' }}>Bus</option>
                                                    <option value="Private Car" {{ old('trans_makkah_jeddah', $package->trans_makkah_jeddah) == 'Private Car' ? 'selected' : '' }}>Private Car</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2 trans-segment" data-segment="madinah_madinah">
                                                ...
                                                <select name="trans_madinah_madinah" class="form-select">
                                                    <option value="">Select Option</option>
                                                    <option value="Bus" {{ old('trans_madinah_madinah', $package->trans_madinah_madinah) == 'Bus' ? 'selected' : '' }}>Bus</option>
                                                    <option value="Private Car" {{ old('trans_madinah_madinah', $package->trans_madinah_madinah) == 'Private Car' ? 'selected' : '' }}>Private Car</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2 trans-segment" data-segment="madinah_jeddah">
                                                ...
                                                <select name="trans_madinah_jeddah" class="form-select">
                                                    <option value="">Select Option</option>
                                                    <option value="Bus" {{ old('trans_madinah_jeddah', $package->trans_madinah_jeddah) == 'Bus' ? 'selected' : '' }}>Bus</option>
                                                    <option value="Train" {{ old('trans_madinah_jeddah', $package->trans_madinah_jeddah) == 'Train' ? 'selected' : '' }}>Train</option>
                                                    <option value="Private Car" {{ old('trans_madinah_jeddah', $package->trans_madinah_jeddah) == 'Private Car' ? 'selected' : '' }}>Private Car</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="requirements-wrapper" id="requirementsWrapper">
                                                @php
                                                    $requirements = old('requirements', (is_array($package->requirements) ? $package->requirements : (empty($package->requirements) ? [] : explode("\n", $package->requirements))));
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="features" rows="6" class="form-control summernote">{{ old('features', $package->features) }}</textarea>
                                        </div>

                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">Description</label>
                                            <textarea name="description" rows="6" class="form-control summernote">{{ old('description', $package->description) }}</textarea>
                                        </div>
