...
@section('title', 'Edit International Package')
@section('header-title', 'Edit International Package')
@section('content')
    <div class="content-page">
        <div class="content">
            <div class="container">
                <div class="py-3">
                    <h4 class="fs-18 fw-semibold m-0">Edit International Package</h4>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('international-package.update', $package->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="destination_country" class="form-control"
                                                value="{{ old('destination_country', $package->destination_country) }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="destination_city" class="form-control"
                                                value="{{ old('destination_city', $package->destination_city) }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="star_rating" class="form-select">
                                                ...
                                                @foreach (['3 Star', '4 Star', '5 Star'] as $rating)
                                                    <option value="{{ $rating }}"
                                                        {{ old('star_rating', $package->star_rating) == $rating ? 'selected' : '' }}>
                                                        {{ $rating }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="visa_required" class="form-select">
                                                <option value="1"
                                                    {{ old('visa_required', $package->visa_required) == 1 ? 'selected' : '' }}>
                                                    Yes</option>
                                                <option value="0"
                                                    {{ old('visa_required', $package->visa_required) == 0 ? 'selected' : '' }}>
                                                    No</option>
                                            </select>
                                        </div>
