...
@section('header-title', 'Add Package')
@section('content')
    <div class="content-page">
        <div class="content">
            <div class="container">
                <div class="py-3">
                    <h4 class="fs-18 fw-semibold m-0">Add Package</h4>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="type" class="form-select" required>
                                                ...
                                                <option value="hajj" {{ old('type') == 'hajj' ? 'selected' : '' }}>Hajj
                                                </option>
                                                <option value="umrah" {{ old('type') == 'umrah' ? 'selected' : '' }}>
                                                    Umrah</option>
                                            </select>
                                        </div>
    ...
    <script>
        // Hotel select hone par distance field auto-fill ho jayegi
