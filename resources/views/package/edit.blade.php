...
@section('header-title', 'Edit Package')
@section('content')
    <div class="content-page">
        <div class="content">
            <div class="container">
                <div class="py-3">
                    <h4 class="fs-18 fw-semibold m-0">Edit Package</h4>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="type" class="form-select" required>
                                                ...
                                                <option value="hajj"
                                                    {{ old('type', $package->type) == 'hajj' ? 'selected' : '' }}>Hajj
                                                </option>
                                                <option value="umrah"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" name="travel_date_from" class="form-control"
                                                value="{{ old('travel_date_from', $package->travel_date_from ? \Carbon\Carbon::parse($package->travel_date_from)->format('Y-m-d') : '') }}">
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Travel Date To</label>
                                            <input type="date" name="travel_date_to" class="form-control"
                                                value="{{ old('travel_date_to', $package->travel_date_to ? \Carbon\Carbon::parse($package->travel_date_to)->format('Y-m-d') : '') }}">
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="requirements" rows="4" class="form-control summernote">{{ old('requirements', $package->requirements) }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if ($package->image)
                                                <img src="{{ asset('assets/images/packages/' . $package->image) }}"
                                                    width="80" class="mt-2 rounded d-block">
                                            @endif
                                        </div>
                                    </div>
