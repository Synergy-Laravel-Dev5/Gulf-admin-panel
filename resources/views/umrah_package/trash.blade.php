...
@section('title', 'Umrah Packages Trash')
@section('header-title', 'Umrah Packages Trash')
@section('content')
            ...
            <div class="container">
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Umrah Packages Trash</h4>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="{{ route('umrah-package.index') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Trashed Umrah Packages</h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($packages as $package)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('umrah-package.restore', $package->id) }}"
